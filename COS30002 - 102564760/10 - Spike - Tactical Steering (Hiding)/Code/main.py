...
from environmental_object import Environmental_Oject
...
def on_key_press(symbol, modifiers):
    ...
    if symbol == KEY.O:
        world.objects.append(Environmental_Oject(world, 30.0))
...
if __name__ == '__main__':
    ...
    world = World(500, 500)
    # add one agent
    world.agents.append(Hunter(world))
