...
class BoxWorldWindow(pyglet.window.Window):
    ...
    def __init__(self, filename, **kwargs):
        ...
        self.world.agents.append(Agent(self.world, self.world.get_box_by_index(0, self.world.ny -1), True))
        self.world.agents.append(Agent(self.world, self.world.get_box_by_index(self.world.nx -1, 0), True))
        self.world.agents.append(Agent(self.world, self.world.get_box_by_index(0, 0), False))
        self.world.agents.append(Agent(self.world, self.world.get_box_by_index(self.world.nx -1, self.world.ny -1), False))
